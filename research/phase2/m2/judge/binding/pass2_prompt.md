You are performing PASS 2 of the M2 blind reconstruction test (Federated Agent Memory, round R2).
...
- research/phase2/m2/judge/binding/pass2_input.jsonl — 240 items, one JSON object per line, fields: item_id, codename, question, render.
...
- Work in English.
Output: write research/phase2/m2/judge/binding/pass2_answers.jsonl with one JSON object per line, in the order the input file presents the items:
{"item_id": "<id>", "pass": 2, "q1": "...", "q2": "...", "q3": "..."}
