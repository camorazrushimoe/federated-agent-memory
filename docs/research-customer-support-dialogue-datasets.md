...
**Related research brief (hypotheses for analysts):** [`research-brief-cross-session-experience.md`](./research-brief-cross-session-experience.md)
...
|---------|------|------------------|--------------------|-------|------|
| **Syncora Customer Support Conversations** | Fully synthetic, multi-turn | Large (~629 MB CSV; thousands of multi-turn dialogues) | SaaS, Travel, Education, E-commerce (+ banking/telecom variants) | **Primary for hypothesis work.** Rich metadata: industry, category, channel, sentiment, intent, priority, status. Privacy-safe. | [Hugging Face](https://huggingface.co/datasets/syncora/customer_support_conversations_dataset) / [Kaggle](https://www.kaggle.com/datasets/syncoraai/customer-support-conversations) |
...
- **Hypothesis exploration (current):** see `research-brief-cross-session-experience.md` — cluster similar problems, extract success/failure paths, draft experience cards.
