...
- run dir: `/opt/data/fam/standalone/h2-federated-scoped-memory/runs/2026-08-29_S0_checks`
- stage: S0 smoke · fixtures only · zero LLM calls (S2 replays the committed bake)
- HARD: 58 passed, 0 failed, 11 deferred · SOFT: 5 total, 0 failed
...
| C-REGISTRY | harness | HARD | PASS | rows 73, duplicate ids [], missing ids [] | every CHECKS.md id appears in checks.json exactly once (missing id = fail) |  |
