...
## 1. Run identity
- run dir: `2026-08-29_PhaseC3_s3match-shape-req` (RUN-PROTOCOL §3)
...
- pool sessions: 380, unique tag_keys: 335, median bucket size: 1 (success criterion: median > 1)
...
|---|---|---|---|---|
| B0 | 0.0 | 0.0 | 1.0 | 60 |
| B1 | 0.0833 | 0.0167 | 0.9 | 60 |
| B2 | 0.0833 | 0.0167 | 0.9 | 60 |
| B3 | 0.7667 | 0.0 | 0.2333 | 60 |
| T | 0.0833 | 0.0167 | 0.9 | 60 |

*Every L2-usefulness number above: agent-labeled gold (deepseek-v4-pro) — NOT human gold*

**Primary read:** T.hit = 0.0833 vs B1.hit = 0.0833 on the same n=60
...
- unique_served=14 top1_share=0.0714 top3_share=0.2143 explore_fill=0.0 explore_promote=0 decay_fired=0
...
- `packet_tokens_p50` = 45
- `packet_tokens_p95` = 617
- `packet_tokens_max` = 956
- `packet_tokens_per_query_mean` = 106.9
- `implied_agent_usd_per_1000` = None
- `serve_latency_p50` = 141.0
- `serve_latency_p95` = 151.0
...
## 8. Verdict
**NOT FIT — T.hit 0.0833 <= B1.hit 0.0833 (ranker adds nothing over random similar session)**
