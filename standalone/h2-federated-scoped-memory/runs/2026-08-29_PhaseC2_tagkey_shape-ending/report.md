...
- slice queries: 60, unique query tag_keys: 58, median bucket size: 1 (success criterion: median > 1) — ratings written under a query's key are almost never re-read by another query, so S7 learning cannot transfer (mechanism criterion FAILS)
