# Run 2026-08-28_S0_deepseek-v4-pro-portability

## 1. Identity

- stage: S0; extract model: deepseek-v4-pro; timeline: compressed; agent_pool_size: 4
- git_commit: {'sha': '57fd25c09d19af83b27e661007ad7263d224eddf', 'dirty': True}
- replay_of: None
...
```json
{
  "deterministic_half_wall_clock_s": 39.276,
  "extract": {
    "calls": 42,
    ...
    "ms_p95": 3758,
    "prompt_tokens": 17402,
    "usd_per_1000_dialogues": 1.192043,
    "usd_total": 0.019073
  },
  "notes": [
...
- fx10_2: ok=False expected=fixture fx10_2: expected 1 canonical, 9 merged, observed {'canonicals': 2, 'merged': 8} observed={}
- fx10_3: ok=True expected=votes=1, private observed={"extract": {"extracted": 10, "rejected": 0, "skipped": 0, "unparseable": 0, "pii_flagged": 10}, "cluster": {"ran": true, "scopes": 1, "clusters_formed": 1, "merged": 8, "promoted": 0, "already_shared": 0, "stale": 0, "independence": "agent+dialogue", "unlock_conflict": 0, "note": "unlock_conflict requires ground-truth labels, which are stripped at ingest (C-L2); eval.py computes the real value from labels + cluster membership into metrics.json"}, "votes": 1, "status": "private"}
- fx10_4: ok=False expected=fx10_2 store unavailable observed={}
...
- fx_live: ok=False expected=fx10_2 store unavailable observed={}
